...
module "cluster_roles" {
  source = "github.com/wso2/open-cloud-datacenter//modules/tenancy/cluster-roles?ref=terraform/v0.1.0"
}

module "tenant_space_iam" {
  source = "github.com/wso2/open-cloud-datacenter//modules/tenancy/tenant-space?ref=terraform/v0.1.0"
  ...
  group_role_bindings = [
    {
